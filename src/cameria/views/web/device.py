...
def list_devices():
    return flask.render_template(
        "device/list.html.tpl", link="devices", sub_link="list"
    )
...
def new_device():
    return flask.render_template(
        "device/new.html.tpl", link="devices", sub_link="create", device={}, errors={}
    )
...
def create_device():
    ...
    return flask.redirect(flask.url_for("show_device", device_id=device.device_id))
...
def show_device(device_id):
    ...
    return flask.render_template(
        "device/show.html.tpl", link="devices", sub_link="show", device=device
    )
...
def update_device(device_id):
    ...
    # was just updated
    return flask.redirect(flask.url_for("show_device", device_id=device_id))
...
def delete_device(device_id):
    device = models.Device.get(device_id=device_id)
    device.delete()
    return flask.redirect(flask.url_for("list_devices"))
