...
def signin():
    return flask.render_template("signin.html.tpl")
...
def login():
    ...
    try:
        ...
        return flask.render_template(
            "signin.html.tpl", username=username, error=error.message
        )
...
@quorum.ensure("about")
def about():
    return flask.render_template("about.html.tpl", link="about")
