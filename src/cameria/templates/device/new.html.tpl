...
{% block content %}
    <form action="{{ url_for('create_device') }}" method="post" class="form">
        ...
        <div class="input">
            <input type="text" class="text-field focus" name="device_id" placeholder="eg: device_xz" value="{{ device.device_id }}"
        ...
        <div class="input">
            <input type="text" class="text-field" name="type" placeholder="eg: axis" value="{{ device.type }}"
        ...
        <div class="input">
            <input type="text" class="text-field" name="model_d" placeholder="eg: 211" value="{{ device.model_d }}"
        ...
        <div class="input">
            <input type="text" class="text-field" name="resolution" placeholder="eg: 640x480" value="{{ device.resolution }}"
        ...
        <div class="input">
            <input type="text" class="text-field" name="width" placeholder="eg: 640" value="{{ device.width }}"
        ...
        <div class="input">
            <input type="text" class="text-field" name="height" placeholder="eg: 480" value="{{ device.height }}"
        ...
        <div class="input">
            <input type="text" class="text-field" name="compression" placeholder="eg: 20" value="{{ device.compression }}"
        ...
        <div class="input">
            <input type="text" class="text-field" name="clock" placeholder="eg: 0" value="{{ device.clock }}"
