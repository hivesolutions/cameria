    ...
    <table>
        <tbody>
            ...
            <tr>
                ...
                <td class="left value" width="50%">{{ device.resolution|unset("N/A", True) }}</td>
            </tr>
            <tr>
                <td class="right label" width="50%">width</td>
                <td class="left value" width="50%">{{ device.width|unset("N/A", True) }}</td>
            </tr>
            <tr>
                <td class="right label" width="50%">height</td>
                <td class="left value" width="50%">{{ device.height|unset("N/A", True) }}</td>
            </tr>
            <tr>
                <td class="right label" width="50%">fps</td>
                <td class="left value" width="50%">{{ device.fps|unset("N/A", True) }}</td>
            </tr>
            <tr>
                <td class="right label" width="50%">clock</td>
                <td class="left value" width="50%">{{ device.clock|unset("N/A", True) }}</td>
            </tr>
        </tbody>
    </table>
{% endblock %}
