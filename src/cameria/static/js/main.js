    ...
    jQuery.fn.ucamera = function(options) {
        ...
        var _registerHandlers = function() {
            ...
            matchedObject.load(function() {
                ...
                // data structure
                cameraWidth = cameraWidth > 0 ? cameraWidth : camera.outerWidth();
                cameraHeight = cameraHeight > 0 ? cameraHeight : camera.outerHeight();
                camera.data("width", cameraWidth);
                camera.data("height", cameraHeight);
            });
            ...
            matchedObject.length && _window.keydown(onKeyDown = function(event) {
